...
export const SUBSCRIPTION_TRIAL_DAYS = 2;
...
export const INFOFIELD_WIDTH = 530;
export const DISCLAIMER = "DipMax Export GmbH übernimmt für die dargestellten Informationen und deren Genauigkeit und Vollständigkeit keine Gewährleistung.";
